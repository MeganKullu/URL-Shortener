...
const Info = () => {
    return (
        <div className='bg-slate-100 -mt-20 flex flex-col justify-center items-center pb-20'>
            ...
            <div className='flex w-full xl:max-w-screen-lg 2xl:max-w-screen-xl relative -z-30 '>
                <span className='h-2 w-full bg-cyan'></span>
           </div>

            <div className='lg:flex lg:gap-6 lg:mx-28'>
                <div className='bg-white rounded-lg flex flex-col justify-center items-center lg:items-start  mx-5 lg:mx-0 px-4 pb-6 lg:pb-0 h-72'>
                ...
                <div className='bg-white rounded-lg flex flex-col justify-center items-center lg:items-start mx-5 lg:mx-0 px-4 pb-6 lg:pb-0 mt-20 lg:mt-16 h-72'>
                ...
                <div className='bg-white rounded-lg flex flex-col justify-center items-center lg:items-start mx-5 lg:mx-0 px-4 pb-6 lg:pb-0 mt-20 lg:mt-32 h-72'>
                    <div className=' relative z-50 -mt-20 p-4  rounded-full bg-dark-violet'>
