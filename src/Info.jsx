    ...
    return (
        <div className='bg-slate-100 -mt-20 flex flex-col justify-center items-center pb-20'>
            ...
            <div className='bg-white rounded-lg flex flex-col justify-center items-center mx-5 px-4 pb-4 mt-20 h-72'>
                ...
                <p className='text-grayish-violet text-center'>Improve brand awareness and content discoverability through customizable
